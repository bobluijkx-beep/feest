 ...
 * Components/Actions/Route Handlers in apps/scanner. De echte grens blijft requireRole()
 * zelf — dit is alleen het herbruikbare "haal op, check, en stuur anders door"-stukje. */
