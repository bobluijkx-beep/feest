...
/** Gewone gestylede native <textarea> — zelfde afweging als Select (select.tsx): geen
 * base-ui-primitive nodig voor iets dat de browser al goed genoeg doet, alleen consistente
 * styling met Input ernaast. */
