...
// /login. De echte RBAC-grens zit in requireRole() per pagina/route — dit is alleen de
// coarse "ben je uberhaupt ingelogd"-check.
...
export const config = {
  // manifest.json/sw.js/icons moeten publiek en zonder auth-redirect ophaalbaar blijven,
  // anders breekt PWA-installatie/service-worker-registratie.
