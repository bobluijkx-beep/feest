...
// 1:1-geport van het HR-portal-project (personeel/components/ui/dialog.tsx) — zelfde
// base-ui-Dialog-primitive als de rest van dit component-setje (Button/Input/Select).
...
function DialogFooter({
  ...
  return (
    ...
    >
      {children}
      {showCloseButton && (
        <DialogPrimitive.Close render={<Button variant="outline" />}>Sluiten</DialogPrimitive.Close>
      )}
    </div>
  );
}
